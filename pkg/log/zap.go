...
func (z *_zap) GetEncoder(config *conf.Zap) zapcore.Encoder {
...
func (z *_zap) GetEncoderConfig(config *conf.Zap) zapcore.EncoderConfig {
...
func (z *_zap) GetEncoderCore(config *conf.Zap, l zapcore.Level, level zap.LevelEnablerFunc) zapcore.Core {
...
func (z *_zap) GetZapCores(config *conf.Zap) []zapcore.Core {
